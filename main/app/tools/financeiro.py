...
query_transactions = search_transactions.copy(update={"name": "query_transactions"})
total_balance = saldo_total.copy(update={"name": "total_balance"})
daily_balance = saldo_diario.copy(update={"name": "daily_balance"})
